...
class TxtRv extends React.Component{
    ...
    render() {
        ...
        const ratioBar = (
            <bs.ProgressBar>
                <bs.ProgressBar className="progress-bar progress-bar-success" now={result[0]*100} label="%(percent)s%" ></bs.ProgressBar>
                <bs.ProgressBar className="progress-bar progress-bar-danger" now={(1-result[0])*100} label="%(percent)s%"></bs.ProgressBar>
            </bs.ProgressBar>
        );
